    ...
    <div class="row g-4">
        <div class="col-md-6">
            <div class="game-card">
                ...
                <a href="/igor_tcc_teste/jogos/queimada.php" class="btn btn-primary">Jogar agora</a>
            </div>
        </div>
        <div class="col-md-6">
            <div class="game-card">
                ...
                <a href="/igor_tcc_teste/jogos/memoria.php" class="btn btn-primary">Jogar agora</a>
            </div>
        </div>
    </div>
